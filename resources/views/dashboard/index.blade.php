...
<div class="relative overflow-x-auto">
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 my-4">
    ...
    <button type="submit" class="flex justify-center rounded-md bg-gray-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-800"><a href="/dashboard/posts/create" class="text-white hover:text-white">Create New Post</a></button>
</div>

@can('admin')
<div class="mt-8">
    <h6 class="d-flex mb-2 border-b border-b-gray-900 font-semibold">
